...
801039b3:	e8 18 36 00 00       	call   80106fd0 <setupkvm>
...
801039d1:	e8 aa 32 00 00       	call   80106c80 <inituvm>
...
80103abb:	e8 b0 30 00 00       	call   80106b70 <switchuvm>
  return 0;
...
80103ada:	e8 11 33 00 00       	call   80106df0 <allocuvm>
...
80103afa:	e8 21 34 00 00       	call   80106f20 <deallocuvm>
...
80103b48:	e8 73 35 00 00       	call   801070c0 <copyuvm>
...
80103f89:	e8 c2 2f 00 00       	call   80106f50 <freevm>
        p->pid = 0;
...
80105286:	8d 5d e0             	lea    -0x20(%ebp),%ebx
{
...
80105299:	0f 88 06 01 00 00    	js     801053a5 <sys_open+0x125>
8010529f:	83 ec 08             	sub    $0x8,%esp
801052a2:	8d 75 e4             	lea    -0x1c(%ebp),%esi
...
801052b2:	0f 88 ed 00 00 00    	js     801053a5 <sys_open+0x125>
    return -1;
...
801052be:	e8 1d f7 ff ff       	call   801049e0 <argstr>
801052c3:	83 c4 10             	add    $0x10,%esp
801052c6:	85 c0                	test   %eax,%eax
801052c8:	0f 88 d7 00 00 00    	js     801053a5 <sys_open+0x125>
801052ce:	83 ec 08             	sub    $0x8,%esp
801052d1:	56                   	push   %esi
801052d2:	6a 01                	push   $0x1
801052d4:	e8 47 f6 ff ff       	call   80104920 <argint>
801052d9:	83 c4 10             	add    $0x10,%esp
801052dc:	85 c0                	test   %eax,%eax
801052de:	0f 88 c1 00 00 00    	js     801053a5 <sys_open+0x125>
    return -1;

  if (trace_enabled) {
801052e4:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
801052ea:	85 db                	test   %ebx,%ebx
801052ec:	74 38                	je     80105326 <sys_open+0xa6>
  while(*p && *p == *q)
801052ee:	0f b6 05 80 3c 11 80 	movzbl 0x80113c80,%eax
    if (strcmp(trace_pathname, path) == 0) {
801052f5:	8b 55 e0             	mov    -0x20(%ebp),%edx
  while(*p && *p == *q)
801052f8:	b9 80 3c 11 80       	mov    $0x80113c80,%ecx
801052fd:	84 c0                	test   %al,%al
801052ff:	75 21                	jne    80105322 <sys_open+0xa2>
80105301:	e9 22 01 00 00       	jmp    80105428 <sys_open+0x1a8>
80105306:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010530d:	8d 76 00             	lea    0x0(%esi),%esi
80105310:	0f b6 41 01          	movzbl 0x1(%ecx),%eax
    p++, q++;
80105314:	83 c1 01             	add    $0x1,%ecx
80105317:	83 c2 01             	add    $0x1,%edx
  while(*p && *p == *q)
8010531a:	84 c0                	test   %al,%al
8010531c:	0f 84 06 01 00 00    	je     80105428 <sys_open+0x1a8>
80105322:	38 02                	cmp    %al,(%edx)
80105324:	74 ea                	je     80105310 <sys_open+0x90>
      trace_counter++;
    }
  }
  begin_op();
80105326:	e8 35 da ff ff       	call   80102d60 <begin_op>

  if(omode & O_CREATE){
8010532b:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
8010532f:	75 7f                	jne    801053b0 <sys_open+0x130>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80105334:	ff 75 e0             	push   -0x20(%ebp)
80105337:	e8 64 cd ff ff       	call   801020a0 <namei>
8010533c:	83 c4 10             	add    $0x10,%esp
8010533f:	89 c6                	mov    %eax,%esi
80105341:	85 c0                	test   %eax,%eax
80105343:	0f 84 84 00 00 00    	je     801053cd <sys_open+0x14d>
      end_op();
      return -1;
    }
    ilock(ip);
...
80105355:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
8010535a:	0f 84 f0 00 00 00    	je     80105450 <sys_open+0x1d0>
      end_op();
      return -1;
    }
  }
...
80105360:	e8 cb ba ff ff       	call   80100e30 <filealloc>
80105365:	89 c7                	mov    %eax,%edi
80105367:	85 c0                	test   %eax,%eax
80105369:	74 29                	je     80105394 <sys_open+0x114>
  struct proc *curproc = myproc();
8010536b:	e8 00 e6 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80105370:	31 db                	xor    %ebx,%ebx
80105372:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(curproc->ofile[fd] == 0){
80105378:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
8010537c:	85 d2                	test   %edx,%edx
8010537e:	74 60                	je     801053e0 <sys_open+0x160>
  for(fd = 0; fd < NOFILE; fd++){
80105380:	83 c3 01             	add    $0x1,%ebx
80105383:	83 fb 10             	cmp    $0x10,%ebx
80105386:	75 f0                	jne    80105378 <sys_open+0xf8>
    if(f)
      fileclose(f);
80105388:	83 ec 0c             	sub    $0xc,%esp
8010538b:	57                   	push   %edi
8010538c:	e8 5f bb ff ff       	call   80100ef0 <fileclose>
...
801053cb:	75 93                	jne    80105360 <sys_open+0xe0>
      end_op();
801053cd:	e8 fe d9 ff ff       	call   80102dd0 <end_op>
      return -1;
801053d2:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801053d7:	eb 40                	jmp    80105419 <sys_open+0x199>
...
801053e8:	e8 73 c4 ff ff       	call   80101860 <iunlock>
  end_op();
801053ed:	e8 de d9 ff ff       	call   80102dd0 <end_op>
...
8010542b:	0f 85 f5 fe ff ff    	jne    80105326 <sys_open+0xa6>
      trace_counter++;
80105431:	83 05 80 3d 11 80 01 	addl   $0x1,0x80113d80
  begin_op();
80105438:	e8 23 d9 ff ff       	call   80102d60 <begin_op>
  if(omode & O_CREATE){
8010543d:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105441:	0f 84 ea fe ff ff    	je     80105331 <sys_open+0xb1>
80105447:	e9 64 ff ff ff       	jmp    801053b0 <sys_open+0x130>
8010544c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(ip->type == T_DIR && omode != O_RDONLY){
80105450:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80105453:	85 c9                	test   %ecx,%ecx
80105455:	0f 84 05 ff ff ff    	je     80105360 <sys_open+0xe0>
8010545b:	e9 34 ff ff ff       	jmp    80105394 <sys_open+0x114>
...
80105474:	e8 67 f5 ff ff       	call   801049e0 <argstr>
...
8010548f:	e8 3c f6 ff ff       	call   80104ad0 <create>
...
801054d4:	e8 07 f5 ff ff       	call   801049e0 <argstr>
...
801054e9:	e8 32 f4 ff ff       	call   80104920 <argint>
  if((argstr(0, &path)) < 0 ||
...
801054fe:	e8 1d f4 ff ff       	call   80104920 <argint>
     argint(1, &major) < 0 ||
...
8010551e:	e8 ad f5 ff ff       	call   80104ad0 <create>
     argint(2, &minor) < 0 ||
...
8010556d:	e8 6e f4 ff ff       	call   801049e0 <argstr>
...
80105615:	e8 c6 f3 ff ff       	call   801049e0 <argstr>
...
80105631:	e8 ea f2 ff ff       	call   80104920 <argint>
...
80105650:	e8 0b f0 ff ff       	call   80104660 <memset>
...
8010567a:	e8 11 f2 ff ff       	call   80104890 <fetchint>
...
80105698:	e8 33 f2 ff ff       	call   801048d0 <fetchstr>
...
80105701:	e8 6a f2 ff ff       	call   80104970 <argptr>
...
801057cc:	e8 0f f2 ff ff       	call   801049e0 <argstr>
801057d1:	83 c4 10             	add    $0x10,%esp
801057d4:	85 c0                	test   %eax,%eax
801057d6:	78 31                	js     80105809 <sys_trace+0x49>
    return -1;
  }
  strcpy(trace_pathname, pathname);
801057d8:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  while((*s++ = *t++) != 0)
801057db:	31 c0                	xor    %eax,%eax
801057dd:	8d 76 00             	lea    0x0(%esi),%esi
801057e0:	0f b6 14 01          	movzbl (%ecx,%eax,1),%edx
801057e4:	83 c0 01             	add    $0x1,%eax
801057e7:	88 90 7f 3c 11 80    	mov    %dl,-0x7feec381(%eax)
801057ed:	84 d2                	test   %dl,%dl
801057ef:	75 ef                	jne    801057e0 <sys_trace+0x20>
  trace_counter = 0;
801057f1:	c7 05 80 3d 11 80 00 	movl   $0x0,0x80113d80
801057f8:	00 00 00 
  trace_enabled = 1;
  return 0;
801057fb:	31 c0                	xor    %eax,%eax
  trace_enabled = 1;
801057fd:	c7 05 60 3c 11 80 01 	movl   $0x1,0x80113c60
80105804:	00 00 00 
}
80105807:	c9                   	leave  
80105808:	c3                   	ret    
...
80105810 <sys_getcount>:

int sys_getcount(void) {

  return trace_counter;
}
80105810:	a1 80 3d 11 80       	mov    0x80113d80,%eax
80105815:	c3                   	ret    
...
8010585c:	e8 bf f0 ff ff       	call   80104920 <argint>
...
801058ad:	e8 6e f0 ff ff       	call   80104920 <argint>
...
801058fd:	e8 1e f0 ff ff       	call   80104920 <argint>
...
80105910:	68 c0 3d 11 80       	push   $0x80113dc0
80105915:	e8 86 ec ff ff       	call   801045a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010591a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010591d:	8b 1d a0 3d 11 80    	mov    0x80113da0,%ebx
  while(ticks - ticks0 < n){
...
80105933:	68 c0 3d 11 80       	push   $0x80113dc0
80105938:	68 a0 3d 11 80       	push   $0x80113da0
8010593d:	e8 fe e6 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
80105942:	a1 a0 3d 11 80       	mov    0x80113da0,%eax
...
80105960:	68 c0 3d 11 80       	push   $0x80113dc0
80105965:	e8 d6 eb ff ff       	call   80104540 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105983:	68 c0 3d 11 80       	push   $0x80113dc0
80105988:	e8 b3 eb ff ff       	call   80104540 <release>
  return 0;
...
801059a4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059a7:	68 c0 3d 11 80       	push   $0x80113dc0
801059ac:	e8 ef eb ff ff       	call   801045a0 <acquire>
  xticks = ticks;
801059b1:	8b 1d a0 3d 11 80    	mov    0x80113da0,%ebx
  release(&tickslock);
801059b7:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801059be:	e8 7d eb ff ff       	call   80104540 <release>
  return xticks;
}
...
80105a07:	c7 04 c5 02 3e 11 80 	movl   $0x8e000008,-0x7feec1fe(,%eax,8)
80105a0e:	08 00 00 8e 
80105a12:	66 89 14 c5 00 3e 11 	mov    %dx,-0x7feec200(,%eax,8)
80105a19:	80 
80105a1a:	c1 ea 10             	shr    $0x10,%edx
80105a1d:	66 89 14 c5 06 3e 11 	mov    %dx,-0x7feec1fa(,%eax,8)
80105a24:	80 
  for(i = 0; i < 256; i++)
...
80105a37:	c7 05 02 40 11 80 08 	movl   $0xef000008,0x80114002
80105a3e:	00 00 ef 
  initlock(&tickslock, "time");
80105a41:	68 a1 7a 10 80       	push   $0x80107aa1
80105a46:	68 c0 3d 11 80       	push   $0x80113dc0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a4b:	66 a3 00 40 11 80    	mov    %ax,0x80114000
80105a51:	c1 e8 10             	shr    $0x10,%eax
80105a54:	66 a3 06 40 11 80    	mov    %ax,0x80114006
  initlock(&tickslock, "time");
80105a5a:	e8 71 e9 ff ff       	call   801043d0 <initlock>
}
...
80105a7b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a7f:	b8 00 3e 11 80       	mov    $0x80113e00,%eax
...
80105b12:	0f 84 b8 00 00 00    	je     80105bd0 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b18:	e8 53 de ff ff       	call   80103970 <myproc>
...
80105bb2:	e8 b9 dd ff ff       	call   80103970 <myproc>
80105bb7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bbe:	e8 ad dd ff ff       	call   80103970 <myproc>
...
80105bd4:	0f 85 3e ff ff ff    	jne    80105b18 <trap+0x78>
    yield();
80105bda:	e8 11 e4 ff ff       	call   80103ff0 <yield>
...
80105bef:	e8 5c dd ff ff       	call   80103950 <cpuid>
...
80105c35:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c38:	e8 23 ee ff ff       	call   80104a60 <syscall>
    if(myproc()->killed)
...
80105c53:	5d                   	pop    %ebp
      exit();
80105c54:	e9 37 e1 ff ff       	jmp    80103d90 <exit>
...
80105c9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105ca0:	e8 ab dc ff ff       	call   80103950 <cpuid>
80105ca5:	85 c0                	test   %eax,%eax
80105ca7:	0f 85 28 fe ff ff    	jne    80105ad5 <trap+0x35>
      acquire(&tickslock);
80105cad:	83 ec 0c             	sub    $0xc,%esp
80105cb0:	68 c0 3d 11 80       	push   $0x80113dc0
80105cb5:	e8 e6 e8 ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105cba:	c7 04 24 a0 3d 11 80 	movl   $0x80113da0,(%esp)
      ticks++;
80105cc1:	83 05 a0 3d 11 80 01 	addl   $0x1,0x80113da0
      wakeup(&ticks);
80105cc8:	e8 33 e4 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105ccd:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80105cd4:	e8 67 e8 ff ff       	call   80104540 <release>
...
80105d05:	e8 46 dc ff ff       	call   80103950 <cpuid>
...
{
  if(!uart)
80105d30:	a1 00 46 11 80       	mov    0x80114600,%eax
...
80105db7:	74 78                	je     80105e31 <uartinit+0xd1>
  uart = 1;
80105db9:	c7 05 00 46 11 80 01 	movl   $0x1,0x80114600
80105dc0:	00 00 00 
...
80105de9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105df0:	a1 00 46 11 80       	mov    0x80114600,%eax
...
80105e40 <uartputc>:
  if(!uart)
80105e40:	a1 00 46 11 80       	mov    0x80114600,%eax
...
80106a75:	e8 e6 db ff ff       	call   80104660 <memset>
...
80106ad3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106ad6:	e8 75 ce ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106b60:	a1 04 46 11 80       	mov    0x80114604,%eax
...
80106b94:	0f 84 c2 00 00 00    	je     80106c5c <switchuvm+0xec>
  pushcli();
80106b9a:	e8 b1 d8 ff ff       	call   80104450 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b9f:	e8 4c cd ff ff       	call   801038f0 <mycpu>
80106ba4:	89 c3                	mov    %eax,%ebx
80106ba6:	e8 45 cd ff ff       	call   801038f0 <mycpu>
80106bab:	89 c7                	mov    %eax,%edi
80106bad:	e8 3e cd ff ff       	call   801038f0 <mycpu>
80106bb2:	83 c7 08             	add    $0x8,%edi
80106bb5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106bb8:	e8 33 cd ff ff       	call   801038f0 <mycpu>
...
80106c01:	e8 ea cc ff ff       	call   801038f0 <mycpu>
...
80106c24:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c27:	e8 c4 cc ff ff       	call   801038f0 <mycpu>
...
80106c49:	5d                   	pop    %ebp
  popcli();
80106c4a:	e9 51 d8 ff ff       	jmp    801044a0 <popcli>
...
80106caf:	e8 ac d9 ff ff       	call   80104660 <memset>
...
80106ce2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ce3:	e9 18 da ff ff       	jmp    80104700 <memmove>
...
80106e3b:	e8 20 d8 ff ff       	call   80104660 <memset>
...
80106ff0:	e8 6b d6 ff ff       	call   80104660 <memset>
...
8010705b:	a3 04 46 11 80       	mov    %eax,0x80114604
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107290:	e8 6b d4 ff ff       	call   80104700 <memmove>
    len -= n;
    buf += n;
